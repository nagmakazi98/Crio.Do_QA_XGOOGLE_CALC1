...
public class TestCases {
    ...
    public void Testcase01() throws InterruptedException{
        ...
        if(currentURL.contains("google.com")){
            System.out.println("Veried: url of the page contains \'google.com\'");
        }
        else{
            System.out.println("UnVerifed: url of the page does not contain \'google.com\'");
            driver.quit();
        }

        WebElement googlesearchbox = driver.findElement(By.xpath("//*[@id='APjFqb']"));
        googlesearchbox.sendKeys("google calculator");
        ...
        for(int i=0;i<list.size();i++){
            ...
            if(listitem.contains("google calculator")){
                list.get(i).click();
                break;
            }
        }
